      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            ...
            <i class="fas fa-2x fa-tablet-alt text-primary mb-4"></i> 
        ...
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
            <i class="fas fa-4x  fa-paint-brush text-primary mb-4"></i>
            <h3 class="h4 mb-2">Diseño de calidad</h3>
            <p class="text-muted mb-0"> Diseños profesionales de alta calidad </p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="mt-5">
